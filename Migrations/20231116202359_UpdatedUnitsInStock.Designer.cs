...
namespace WepPha2.Migrations
{
    ...
    [Migration("20231116202359_UpdatedUnitsInStock")]
    partial class UpdatedUnitsInStock
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("WepPha2.Models.PurchaseDetails", b =>
                {
                    ...
                    b.Property<int>("PurchasedMedicineMedicineId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("PurchasedMedicineMedicineId");
            ...
            modelBuilder.Entity("WepPha2.Models.Medicine", b =>
                {
                    b.HasOne("WepPha2.Models.Category", "Category")
                        .WithMany()
            ...
            modelBuilder.Entity("WepPha2.Models.PurchaseDetails", b =>
                {
                    ...
                    b.HasOne("WepPha2.Models.Medicine", "PurchasedMedicine")
                        .WithMany()
                        .HasForeignKey("PurchasedMedicineMedicineId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
